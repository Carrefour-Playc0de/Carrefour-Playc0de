...
test('@Regression @SmokeMenuHamburguesa (B2C-TC-1085) Verificar que al clickear en Menu Carnes y Pescados funciona correctamente', async ({menuHamburCarnesPescados}) => {
