...
test('@Smoke @Regression (B2C-TC-1086) Verificar que funciona el Menu Carnes y Pescados: VER TODO', async ({menuHamburCarnesPescadosVerTodo}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1010) Verificar que funciona el Menu Carnes y Pescados: Achuras y Embutidos', async ({menuHamburCarnesPescadosAchurasEmbutidos}) => {
...
test('@Regression @MenuHamburguesa(B2C-TC-1012) Verificar que funciona el Menu Carnes y Pescados: Carbon y Encendido', async ({menuHamburCarnesPescadosCarbonEncendido}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1009) Verificar que funciona el Menu Carnes y Pescados: Carne de Cerdo', async ({menuHamburCarnesPescadosCarneCerdo}) => {

    await test.step('Click en Carne de Cerdo', async () => {
        await menuHamburCarnesPescadosCarneCerdo.clickCarnesPescadosCarneCerdo()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-331) Verificar que funciona el Menu Carnes y Pescados: Carne Vacuna', async ({menuHamburCarnesPescadosCarneVacuna}) => {

    await test.step('Click en Carne Vacuna', async () => {
        await menuHamburCarnesPescadosCarneVacuna.clickCarnesPescadosCarneVacuna()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-1011) Verificar que funciona el Menu Carnes y Pescados: Pescados y Mariscos', async ({menuHamburCarnesPescadosPescadosMariscos}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1008) Verificar que funciona el Menu Carnes y Pescados: Pollo y Granja', async ({menuHamburCarnesPescadosPolloGranja}) => {
