...
test('@Smoke @Regression @MenuHamburguesa (B2C-TC-1112) Verificar que funciona el Menu Mascotas: VER TODO', async ({menuHamburMascotasVerTodos}) => {

    await test.step('Click en Mascotas VER TODO', async () => {
        await menuHamburMascotasVerTodos.clickMascotasVerTodos()
    })
})
test('@Smoke @Regression @MenuHamburguesa (B2C-TC-338) Verificar que funciona el Menu Mascotas: Alimentos y Snacks para Perros', async ({menuHamburMascotasAlimentosSnacksPerros}) => {
