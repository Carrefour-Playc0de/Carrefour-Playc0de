...
test('@Smoke @Regression (B2C-TC-1162) Verificar que funciona el Menu Congelados: VER TODO', async ({menuHamburCongeladosVerTodos}) => {

    await test.step('Click en Congelados VER TODO', async () => {
        await menuHamburCongeladosVerTodos.clickCongeladosVerTodos()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-1162) Verificar que funciona el Menu Congelados: Hamburguesas', async ({menuHamburCongeladosHamburguesas}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1162) Verificar que funciona el Menu Congelados: Papas', async ({menuHamburCongeladosPapas}) => {

    await test.step('Click en Papas', async () => {
        await menuHamburCongeladosPapas.clickCongeladosPapas()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-1162) Verificar que funciona el Menu Congelados: Verduras y Frutas', async ({menuHamburCongeladosVerdurasFrutas}) => {

    await test.step('Click en Verduras y Frutas', async () => {
        await menuHamburCongeladosVerdurasFrutas.clickCongeladosVerdurasFrutas()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-1162) Verificar que funciona el Menu Congelados: Comidas y Panificados', async ({menuHamburCongeladosComidasPanificados}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1162) Verificar que funciona el Menu Congelados: Helados y Postres', async ({menuHamburCongeladosHeladosPostres}) => {
