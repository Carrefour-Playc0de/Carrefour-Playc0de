...
// })
//
// test(' (B2C-TC-1126) Verificar que al clickear el boton CONTINUAR > del modal RETIRO O DRIVER se direcciona correctamente', async ({seleccionaTiendaBotonContinuar}) => {
//
