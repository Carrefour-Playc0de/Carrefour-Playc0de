...
// })
//
// test('Change birthdate', async ({ profilePage }) => {
...
// })
//
// test('Change personal text', async ({ profilePage }) => {
...
// })
//
// test('Change signature', async ({ profilePage }) => {
...
// })
//
// test('Change location', async ({ profilePage }) => {
