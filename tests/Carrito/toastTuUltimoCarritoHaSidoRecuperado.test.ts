...
test('(B2C-TC-1098) Verificar que se cierra el toast Tu ultimo carrito ha sido recuperado al clickear la X del toast', async ({toastTuUltimoCarritoHaSidoRecuperado}) => {
